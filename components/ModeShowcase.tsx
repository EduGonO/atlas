          ...
          {modes.map((mode) => {
            ...
            return (
              <article
                key={mode.name}
                style={accentStyles}
                className="group relative isolate flex h-full flex-1 flex-col overflow-hidden rounded-[26px] border border-white/10 bg-white/[0.035] p-6 transition duration-300 ease-out hover:scale-[1.015] hover:border-white/14 md:min-w-0"
              >
                ...
                <div className="relative flex h-full flex-col gap-4 text-white/70">
                  ...
                  <span
                    className="inline-flex w-fit items-center gap-2 rounded-full border px-3 py-1 text-[11px] uppercase tracking-[0.2em] text-[color:var(--accent)] transition-colors duration-300 group-hover:border-[color:var(--accent)]"
                    style={{ backgroundColor: 'var(--accent-soft)', borderColor: 'var(--accent-border)' }}
                  >
                    {mode.tagline}
                  </span>
                  ...
                  <div className="mt-auto pt-2 text-xs uppercase tracking-[0.2em] text-white/45">Designed for daily play</div>
                </div>
              </article>
            );
          })}
