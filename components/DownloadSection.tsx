        ...
        <div className="space-y-5">
          ...
          <form className="mt-6 flex w-full flex-col gap-3 sm:flex-row sm:items-center">
            <input
              ...
              className="h-12 w-full flex-1 rounded-full border border-white/12 bg-white/10 px-5 text-sm text-white placeholder:text-white/40 focus:border-white/35 focus:outline-none"
            />
            <button
              type="submit"
              className="h-12 w-full rounded-full bg-white px-6 text-sm font-semibold text-surface shadow-[0_24px_44px_rgba(15,23,42,0.3)] transition hover:-translate-y-0.5 sm:w-auto"
            >
              Join the waitlist
            </button>
          </form>
